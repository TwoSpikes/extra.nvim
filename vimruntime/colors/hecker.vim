...
hi CursorNormal guifg=NONE guibg=#0050ff gui=NONE cterm=NONE
...
if &background ==# 'dark'
  ...
  hi LineNr ctermfg=251 ctermbg=NONE cterm=bold
  ...
  if &background ==# 'dark'
    if exists('g:use_transparent_bg')
      ...
      \|| g:use_transparent_bg ==# "dark"
        ...
        hi Normal ctermfg=231 ctermbg=NONE cterm=NONE guifg=#ffffff guibg=#202020 gui=NONE
      endif
    endif
    call CopyHighlightGroup("Normal", "NotifyBackground")
    hi NotifyBackground ctermbg=18 guibg=#505050
    hi NormalNC ctermfg=15 ctermbg=NONE cterm=NONE guifg=#ffefff guibg=#202020 gui=NONE
    hi MsgArea ctermfg=15 ctermbg=NONE cterm=NONE guifg=#f0f0e0 guibg=#181818 gui=NONE
    ...
    hi Statusline ctermfg=18 ctermbg=194 cterm=bold guifg=#ffffff guibg=#303030 gui=NONE
    hi Statuslinemod ctermfg=57 ctermbg=155 cterm=bold guifg=#ffffd0 guibg=#870000 gui=bold
    ...
    hi Statusline0mac ctermfg=57 ctermbg=155 cterm=bold guifg=#870000 guibg=#303030 gui=NONE
    hi Statusline0venv ctermfg=57 ctermbg=155 cterm=bold guifg=#00a0ff guibg=#303030 gui=NONE
    hi Statuslinevenv1 ctermfg=57 ctermbg=155 cterm=bold guifg=#00df5f guibg=#00a0ff gui=NONE
    hi Statuslinemac1 ctermfg=57 ctermbg=155 cterm=bold guifg=#00df5f guibg=#870000 gui=NONE
    hi Statuslinestat1 ctermfg=57 ctermbg=155 cterm=bold guifg=#000000 guibg=#00df5f gui=NONE
    hi Statuslinestat01 ctermfg=57 ctermbg=155 cterm=bold guifg=#00df5f guibg=#303030 gui=NONE
    hi Statuslinestat12 ctermfg=57 ctermbg=155 cterm=bold guifg=#303030 guibg=#00df5f gui=NONE
    hi Statuslinestat2 ctermfg=57 ctermbg=155 cterm=bold guifg=#00df5f guibg=#303030 gui=NONE
    hi StatuslinestatNormTerm ctermfg=57 ctermbg=155 cterm=bold guifg=#0050ff guibg=#5f0000 gui=NONE
    hi StatuslinestatVisuBlock ctermfg=57 ctermbg=155 cterm=bold guifg=#ffaf30 guibg=#870000 gui=NONE
"    hi Statusline ctermfg=17 ctermbg=208 cterm=bold
"    hi StatuslineNC ctermfg=18 ctermbg=195 cterm=reverse
    hi StatuslineNC ctermfg=17 ctermbg=208 cterm=NONE guifg=#f03000 guibg=#303030 gui=bold
...
"    hi TabLine ctermfg=208 ctermbg=17 cterm=NONE
    hi TabLine ctermfg=195 ctermbg=18 cterm=NONE guifg=#ffffff guibg=#006040 gui=NONE
    hi TabLineSec ctermfg=222 ctermbg=18 cterm=NONE guifg=#ffffff guibg=#0060c0 gui=NONE
    hi TabLineToSel ctermfg=222 ctermbg=18 cterm=NONE guifg=#006040 guibg=#00ff60 gui=NONE
    hi TabLineFromSel ctermfg=222 ctermbg=18 cterm=NONE guifg=#00ff60 guibg=#006040 gui=NONE
    hi TabLineToSec ctermfg=222 ctermbg=18 cterm=NONE guifg=#006040 guibg=#0060c0 gui=NONE
    hi TabLineFromSec ctermfg=222 ctermbg=18 cterm=NONE guifg=#0060c0 guibg=#006040 gui=NONE
    hi TabLineFill ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#303030 gui=NONE
"    hi TabLineSel ctermfg=195 ctermbg=18 cterm=bold
    hi TabLineSel ctermfg=194 ctermbg=18 cterm=bold guifg=#000000 guibg=#00ff60 gui=bold
    hi ToolbarLine ctermfg=NONE ctermbg=NONE cterm=NONE
    hi ToolbarButton ctermfg=16 ctermbg=231 cterm=NONE
    hi QuickFixLine ctermfg=16 ctermbg=75 cterm=NONE
    hi CursorLineNrNorm ctermfg=236 ctermbg=220 cterm=bold guifg=#ffffff guibg=#0050ff gui=bold
    call CopyHighlightGroup("CursorLineNrNorm", "CursorLineNr")
    hi CursorLineNrIns ctermfg=15 ctermbg=39 cterm=bold guifg=#000000 guibg=#00df00 gui=bold
    hi CursorLineNrRepl ctermfg=15 ctermbg=128 cterm=bold guifg=#ffffff guibg=#ff00ff gui=bold
    hi CursorLineNrVisu ctermfg=15 ctermbg=18 cterm=bold guifg=#000000 guibg=#ffaf30 gui=bold
    hi LineNrNorm ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#0070ff guibg=#202020 gui=NONE
    call CopyHighlightGroup("LineNrNorm", "LineNr")
    hi LineNrIns ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#00c000 guibg=#202020 gui=italic
    hi LineNrVisu ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#ffaf30 guibg=#202020 gui=italic
    hi LineNrRepl ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#ff00ff guibg=#202020 gui=italic
...
"    hi Error ctermfg=231 ctermbg=160 cterm=NONE
    hi Error ctermfg=160 ctermbg=NONE cterm=strikethrough guifg=#df0000 guibg=NONE gui=strikethrough guisp=red
"    hi ErrorMsg ctermfg=231 ctermbg=160 cterm=NONE
    ...
    hi VisualDim ctermfg=NONE ctermbg=18 cterm=NONE guifg=NONE guibg=#704000 gui=NONE
    hi PseudoVisual ctermfg=NONE ctermbg=18 cterm=NONE guifg=NONE guibg=#505000 gui=NONE
    ...
    hi Comment ctermfg=75 ctermbg=NONE cterm=NONE guifg=#00c000 guibg=NONE gui=NONE
    hi Constant ctermfg=213 ctermbg=NONE cterm=NONE guifg=#f0af60 guibg=NONE gui=NONE
    hi String ctermfg=222 ctermbg=NONE cterm=NONE guifg=#ffaf30 guibg=NONE gui=NONE
    hi Identifier ctermfg=NONE ctermbg=NONE cterm=NONE
    hi StatementNorm ctermfg=228 ctermbg=NONE cterm=NONE guifg=#00a0ff guibg=NONE gui=NONE
    hi StatementIns ctermfg=220 ctermbg=NONE cterm=NONE guifg=#00c000 guibg=NONE gui=NONE
    hi StatementVisu ctermfg=15 ctermbg=18 cterm=bold guifg=#ffaf30 guibg=NONE gui=NONE
    ...
    hi Function ctermfg=220 ctermbg=NONE guifg=#a0ffa0 guibg=NONE gui=NONE
    ...
    hi Type ctermfg=77 ctermbg=NONE cterm=NONE guifg=#a0ffa0 guibg=NONE gui=NONE
    hi PreProc ctermfg=116 ctermbg=NONE cterm=NONE guifg=#ffff80 guibg=NONE gui=NONE
    ...
    hi StatementNorm ctermfg=228 ctermbg=NONE cterm=NONE guifg=#00a0ff guibg=NONE gui=NONE
    hi StatementIns ctermfg=220 ctermbg=NONE cterm=NONE guifg=#00cf00 guibg=NONE gui=NONE
    hi StatementVisu ctermfg=15 ctermbg=18 cterm=bold guifg=#ffa000 guibg=NONE gui=NONE
    call CopyHighlightGroup("StatementNorm", "Statement")
    hi QuickFixLine ctermfg=231 ctermbg=32 cterm=NONE
	  hi CursorLineNrNorm ctermfg=236 ctermbg=220 cterm=bold guifg=#ffffff guibg=#0000ff gui=bold
    call CopyHighlightGroup("CursorLineNrNorm", "CursorLineNr")
    hi CursorLineNrIns ctermfg=15 ctermbg=39 cterm=bold guifg=#000000 guibg=#00ff00 gui=bold
    hi CursorLineNrRepl ctermfg=15 ctermbg=128 cterm=bold guifg=#ffffff guibg=#af00df gui=bold
    hi CursorLineNrVisu ctermfg=15 ctermbg=18 cterm=bold guifg=#000000 guibg=#ffa000 gui=bold
    hi LineNrNorm ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#000000 guibg=#a0f0ff gui=italic
    call CopyHighlightGroup("LineNrNorm", "LineNr")
    hi LineNrIns ctermfg=220 ctermbg=236 cterm=bold,italic guifg=#000000 guibg=#d0ffd0 gui=italic
    hi LineNrVisu ctermfg=15 ctermbg=18 cterm=bold guifg=#000000 guibg=#ffe0a0 gui=italic
...
if &t_Co >= 8
  if &background ==# 'dark'
    ...
    hi Loading0   ctermfg=black ctermbg=red cterm=bold
    hi Loading13  ctermfg=black ctermbg=red cterm=bold
    hi Loading25  ctermfg=black ctermbg=red cterm=bold
    hi Loading38  ctermfg=black ctermbg=red cterm=bold
    hi Loading50  ctermfg=black ctermbg=yellow cterm=bold
    hi Loading63  ctermfg=black ctermbg=yellow cterm=bold
    hi Loading75  ctermfg=black ctermbg=yellow cterm=bold
    hi Loading88  ctermfg=black ctermbg=green cterm=bold
    hi Loading100 ctermfg=black ctermbg=green cterm=bold
